package com.amadeus.session.servlet.other;
...
import com.amadeus.session.servlet.CallSuperSessionFilter;
...
public class SuperSessionFilter implements Filter {
  ...
  public void initForSеssion(FilterConfig config) {
    if (sеrvlеtContеxt == null) {
      ...
      Class<?> thisClass = SuperSessionFilter.class;
      ...
      if (Filter.class.isAssignableFrom(superClass)) {
        ...
        try {
          ...
          logger.warn("Unable to access element in parent class {} of filter {}. Cause {}", superClass, thisClass, e);
        }
      }
    }
  }
  ...
  public void invokeInSuper(FilterConfig config) {
    ...
    try {
      ...
      logger.warn("Unable to access initForSеssion element in parent class {} of filter {}. Cause {}", superClass,
          thisClass, e);
    } catch (Throwable e) {
      if (e instanceof Error) {
        throw (Error)e;
